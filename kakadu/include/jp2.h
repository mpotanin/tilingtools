    ...
    KDU_AUX_EXPORT bool get_signed(int lut_idx) const;
      /* [SYNOPSIS]
         ...
         [ARG: lut_idx]
           ...
           is the value returned by `get_num_luts'.
      */
    KDU_AUX_EXPORT void get_lut(int lut_idx, float lut[]) const;
      /* [SYNOPSIS]
         ...
         [ARG: lut]
           ...
           +0.5 to each entry.
      */
    KDU_AUX_EXPORT void get_lut(int lut_idx, kdu_sample16 lut[]) const;
      /* [SYNOPSIS]
           Offsets and normalizes the original information for the indicated
           palette lookup table, writing the result to the supplied `lut'
           array.  The `lut' entries are filled out as signed, normalized
...
class jp2_channels {
  ...
  */
  public: // Lifecycle member functions
    ...
    jp2_channels(j2_channels *state, int cs_threshold=0, int cs_offset=0)
  ...
  public: // Access member functions
    ...
    KDU_AUX_EXPORT bool
      get_colour_mapping(int colour_idx, int &codestream_component,
                         int &lut_idx, int &codestream_idx) const;
      /* [SYNOPSIS]
  ...
  public: // Access member functions
    ...
    KDU_AUX_EXPORT bool get_vendor_uuid(kdu_byte uuid[]) const;
      /* [SYNOPSIS]
           ...
           `uuid'.
      */
    KDU_AUX_EXPORT kdu_byte *get_vendor_data(int *num_bytes=NULL) const;
      /* [SYNOPSIS]
           If `get_space' returns `JP2_vendor_SPACE', this function returns
