  ...
  public: // Member functions
    ...
    KDU_AUX_EXPORT void
      ...
      /* [SYNOPSIS]
         ...
         [ARG: layer_slopes]
           If non-NULL, this argument points to an array with `num_layer_specs'
           entries, containing the distortion-length slope thresholds
           associated with each quality layer.  This argument is ignored if
           `layer_sizes' is non-NULL, or `num_layer_specs' is 0.  For an
           explanation of the logarithmic representation used for distortion
           length slope thresholds in Kakadu, see the comments associated with
           the `kdu_codestream::flush' function.
         ...
         [ARG: env_dbuf_height]
           ...
           it causes `kdu_multi_analysis::create' to select a good double
           buffering stripe height automatically.
      */
    KDU_AUX_EXPORT bool
      ...
      /* [SYNOPSIS]
           ...
           `env->cs_terminate' before it returns (actually before a final
           call to `kdu_codestream::flush').  This means that you do not
           yourself need to call `kdu_thread_env::cs_terminate' prior to
    ...
    KDU_AUX_EXPORT bool
      ...
      /* [SYNOPSIS]
           ...
           Currently, optimizations exists at least for SSSE3-capable x86
           processors, under the following conditions:
