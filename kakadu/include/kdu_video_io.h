  ...
  public: // Member functions
    ...
    virtual int open_stream(int field_idx, jp2_input_box *input_box)
      ...
      /* [SYNOPSIS]
           ...
           `mj2_video_source' and `jpb_source'.  If this function is
           implemented and the underlying data source is a `jp2_family_src'
           object that is seekable and implements the
           ...
           simultaneously.
           [//]
           The `jp2_input_box' class is not actually defined by this header,
           nor does it need to be defined or implemented unless a derived
           object intends to provide a meaningful implementation of this
           function.
         [RETURNS]
