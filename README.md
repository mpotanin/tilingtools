...
## Download Binary
[Download win-x64 binary 3.0.4 version](http://kosmosnimki.ru/downloads/tilingtools-3.0.4-win-x64.zip) ready for use package compiled with Microsoft Visual C++ 2013.
