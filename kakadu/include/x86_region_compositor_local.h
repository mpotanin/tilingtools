...
/*****************************************************************************/
/* INLINE                   simd_rcopy_region (32-bit)                       */
/*****************************************************************************/

inline bool
  simd_rcopy_region(kdu_uint32 *dst, kdu_uint32 *src,
...
/*****************************************************************************/
/* INLINE               simd_rcopy_region (floating point)                   */
/*****************************************************************************/

inline bool
  simd_rcopy_region(float *dst, float *src, int height, int width, int row_gap)
{
#ifdef KDU_NO_SSE
  return false;
#else // !KDU_NO_SSE
