  ...
  */
  ...
  public: // Functions used to manage cached data
    ...
    KDU_AUX_EXPORT kdu_long
      get_max_codestream_id();
      /* [SYNOPSIS]
           Returns the maximum codesteam-id value associaetd with any
           data-bin written to the cache (or a cache to which we have been
           attached via the `attach_to' function).  If no data-bins content
    ...
    KDU_AUX_EXPORT virtual kdu_long
      ...
      /* [SYNOPSIS]
           ...
           of the first such code-stream.  If there are no matching
           code-streams for which data-bins are available, the function
           return -1.
      */
    KDU_AUX_EXPORT virtual kdu_long
    ...
    KDU_AUX_EXPORT virtual int
      ...
      /* [SYNOPSIS]
         ...
         [RETURNS]
           ...
           not identify an available databin.
         [ARG: is_complete]
