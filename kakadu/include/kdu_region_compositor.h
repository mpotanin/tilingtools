...
class kdu_region_compositor {
  ...
  */
  ...
  public: // Functions used to control dynamic processing
    ...
    KDU_AUX_EXPORT virtual bool
      ...
      /* [SYNOPSIS]
           ...
           an empty `new_region' (unless all processing is complete), but keep
           track internally of what regions the caller has not yet been
           notified of.  This is can have a number of efficiency advantages,
           especially if there are lots of overlapping composited image layers,
           since compositing does not have to be performed each time a piece
           of an image is generated.
           [//]
           You should note that the function also returns an empty `new_region'
           until all processing has been completed if the
           `set_surface_initialization_mode' function has been used to turn
         ...
         [ARG: new_region]
           ...
           used to avoid pre-initialization of surfaces, the `new_region' will
           always be empty until the point at which all processing is
  ...
  public: // Functions used to identify the elements of the composited image
    ...
    /* [SYNOPSIS]
         ...
         [>>] If the `KDU_MRQ_WINDOW' flag is present, the function builds
              ...
              `set_surface_region'.  Indeed if `region' is empty, the entire
  ...
  private: // Helper functions
    ...
    bool find_completed_rects(kdu_dims &region, kdrc_layer *start_layer,
      ...
      /* This function scans through all region processing elements, starting
         ...
         add their completely composited rectangular regions are added to
         the refresh manager.
  ...
  private: // Current composition state
    ...
    kdu_dims total_composition_dims; // Incorporates scaling and orientation
